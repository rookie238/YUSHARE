        ...
        item {
            ...
            Box(
                ...
                Row(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                    Box(modifier = Modifier.size(45.dp).background(Color.White, CircleShape))
                    Icon(painterResource(R.drawable.ic_launcher_foreground), null, tint = Color.White, modifier = Modifier.size(30.dp))
                }
            }
