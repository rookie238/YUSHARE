...
val YuDarkPurple = Color(0xFF23006A) // En koyu mor/lacivert
val YuMediumBlue = Color(0xFF294BA3) // Orta ton mavi (Kartlar vb.)
val YuLime       = Color(0xFFD7F171) // Create butonu ve vurgular
val YuOrange     = Color(0xFFFE9000) // Turuncu kartlar
